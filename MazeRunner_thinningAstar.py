...
if type == 0:
    ## BFS
    path,explored_nodes = SolveMaze_BFS(maze,start,goal,dim)
elif type == 1:
    ## DFS
    path,explored_nodes = SolveMaze_DFS(maze,start,goal,dim)
elif type == 2:
    ## A star euclidean
    path,explored_nodes = SolveMaze_Astar(maze,start,goal,dim,"Euclidean",Visited_start)
elif type == 3:
    ## A star manhattan
    path,explored_nodes = SolveMaze_Astar(maze,start,goal,dim,"Manhattan",Visited_start)
elif type == 4:
    ...
    if path and path[-1] == goal:
        # Thining A star
        path_1,maze,explored_nodes_1 = Solve_ThiningAstar(maze,start,goal,dim,prob)
        print("Length of path thinning A* = %d"%len(path_1))
else:
...
if not Unsolvable and 1:
    ...
    toplevel1(maze,dim,path_1,explored_nodes_1)
    root.mainloop()
